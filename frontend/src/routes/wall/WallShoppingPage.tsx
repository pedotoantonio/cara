      ...
      <section className="rounded-xl bg-surface2/40 p-4 flex flex-col gap-3">
        ...
        <div className="flex flex-wrap gap-2">
          <input
            ...
            className="flex-1 min-w-0 sm:min-w-[220px] bg-bg/70 rounded-md px-3 py-2 text-md"
            autoFocus
          />
          <input
            value={newQty}
    ...
    return (
      ...
      >
        <input
          ...
          className="flex-1 min-w-0 sm:min-w-[150px] bg-surface2/60 rounded-md px-2 py-1.5 text-sm"
          autoFocus
        />
        <input
          value={qty}
  ...
  return (
    ...
    >
      ...
      <button
        ...
        onClick={remove}
        disabled={busy}
        className="text-fg-muted hover:text-alert p-1.5 transition"
        title="Elimina"
